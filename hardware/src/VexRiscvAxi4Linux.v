...
// Component : VexRiscvAxi4Linux
// Git hash  : 680756065e9e6fc50d8c3d6c58191a16e867d822

`timescale 1ns/1ps

module VexRiscvAxi4Linux (
  input  wire          mtip,
  input  wire          msip,
  input  wire          meip,
  input  wire          seip,
  ...
  wire                csr_timerInterrupt;
  wire                csr_externalInterrupt;
  wire                csr_softwareInterrupt;
  wire                csr_externalInterruptS;
  ...
  wire                when_MmuPlugin_l133;
  reg                 MmuPlugin_ports_0_requireMmuLockupCalc;
  wire                when_MmuPlugin_l147;
  wire                when_MmuPlugin_l148;
  wire       [3:0]    MmuPlugin_ports_0_cacheHitsCalc;
  wire                when_MmuPlugin_l140;
  reg                 MmuPlugin_ports_0_requireMmuLockup;
  wire                when_MmuPlugin_l140_1;
  ...
  wire                when_MmuPlugin_l133_1;
  reg                 MmuPlugin_ports_1_requireMmuLockupCalc;
  wire                when_MmuPlugin_l147_1;
  wire                when_MmuPlugin_l148_1;
  wire                when_MmuPlugin_l150;
  wire       [3:0]    MmuPlugin_ports_1_cacheHitsCalc;
  wire                when_MmuPlugin_l140_2;
  reg                 MmuPlugin_ports_1_requireMmuLockup;
  wire                when_MmuPlugin_l140_3;
  ...
  wire                when_MmuPlugin_l306;
  wire                when_MmuPlugin_l308;
  wire                when_MmuPlugin_l314;
  wire                when_MmuPlugin_l314_1;
  wire                when_MmuPlugin_l314_2;
  wire                when_MmuPlugin_l314_3;
  wire                when_MmuPlugin_l308_1;
  wire                when_MmuPlugin_l314_4;
  wire                when_MmuPlugin_l314_5;
  wire                when_MmuPlugin_l314_6;
  wire                when_MmuPlugin_l314_7;
  wire                when_MmuPlugin_l338;
  ...
  assign IBusCachedPlugin_jump_pcLoad_valid = (|{CsrPlugin_redoInterface_valid,{CsrPlugin_jumpInterface_valid,{BranchPlugin_jumpInterface_valid,DBusCachedPlugin_redoBranch_valid}}});
  ...
  assign when_MmuPlugin_l133 = (! IBusCachedPlugin_mmuBus_cmd_1_isStuck);
  always @(*) begin
    MmuPlugin_ports_0_requireMmuLockupCalc = ((1'b1 && (! IBusCachedPlugin_mmuBus_cmd_0_bypassTranslation)) && MmuPlugin_satp_mode);
    if(when_MmuPlugin_l147) begin
      MmuPlugin_ports_0_requireMmuLockupCalc = 1'b0;
    end
    if(when_MmuPlugin_l148) begin
      MmuPlugin_ports_0_requireMmuLockupCalc = 1'b0;
    end
  end

  assign when_MmuPlugin_l147 = ((! MmuPlugin_status_mprv) && (CsrPlugin_privilege == 2'b11));
  assign when_MmuPlugin_l148 = (CsrPlugin_privilege == 2'b11);
  ...
  assign when_MmuPlugin_l140 = (! IBusCachedPlugin_mmuBus_cmd_1_isStuck);
  assign when_MmuPlugin_l140_1 = (! IBusCachedPlugin_mmuBus_cmd_1_isStuck);
  ...
  always @(*) begin
    ...
    if(when_MmuPlugin_l306) begin
      if(when_MmuPlugin_l308) begin
  ...
  assign when_MmuPlugin_l133_1 = (! DBusCachedPlugin_mmuBus_cmd_1_isStuck);
  always @(*) begin
    MmuPlugin_ports_1_requireMmuLockupCalc = ((1'b1 && (! DBusCachedPlugin_mmuBus_cmd_0_bypassTranslation)) && MmuPlugin_satp_mode);
    if(when_MmuPlugin_l147_1) begin
      MmuPlugin_ports_1_requireMmuLockupCalc = 1'b0;
    end
    if(when_MmuPlugin_l148_1) begin
      if(when_MmuPlugin_l150) begin
        MmuPlugin_ports_1_requireMmuLockupCalc = 1'b0;
      end
    end
  end

  assign when_MmuPlugin_l147_1 = ((! MmuPlugin_status_mprv) && (CsrPlugin_privilege == 2'b11));
  assign when_MmuPlugin_l148_1 = (CsrPlugin_privilege == 2'b11);
  assign when_MmuPlugin_l150 = ((! MmuPlugin_status_mprv) || (CsrPlugin_mstatus_MPP == 2'b11));
  ...
  assign when_MmuPlugin_l140_2 = (! DBusCachedPlugin_mmuBus_cmd_1_isStuck);
  assign when_MmuPlugin_l140_3 = (! DBusCachedPlugin_mmuBus_cmd_1_isStuck);
  ...
  always @(*) begin
    ...
    if(when_MmuPlugin_l306) begin
      if(when_MmuPlugin_l308_1) begin
  ...
  assign when_MmuPlugin_l238 = (MmuPlugin_shared_dBusRspStaged_valid && (! MmuPlugin_shared_dBusRspStaged_payload_redo));
  always @(*) begin
  ...
  assign when_MmuPlugin_l250 = (|MmuPlugin_shared_refills);
  assign _zz_MmuPlugin_shared_vpn_0 = (MmuPlugin_shared_refills[0] ? IBusCachedPlugin_mmuBus_cmd_1_virtualAddress : DBusCachedPlugin_mmuBus_cmd_1_virtualAddress);
  assign when_MmuPlugin_l277 = (MmuPlugin_shared_dBusRsp_leaf || MmuPlugin_shared_dBusRsp_exception);
  assign IBusCachedPlugin_mmuBus_busy = ((MmuPlugin_shared_state_1 != MmuPlugin_shared_State_IDLE) && MmuPlugin_shared_portSortedOh[0]);
  assign DBusCachedPlugin_mmuBus_busy = ((MmuPlugin_shared_state_1 != MmuPlugin_shared_State_IDLE) && MmuPlugin_shared_portSortedOh[1]);
  assign when_MmuPlugin_l306 = ((MmuPlugin_shared_dBusRspStaged_valid && (! MmuPlugin_shared_dBusRspStaged_payload_redo)) && (MmuPlugin_shared_dBusRsp_leaf || MmuPlugin_shared_dBusRsp_exception));
  assign when_MmuPlugin_l308 = MmuPlugin_shared_portSortedOh[0];
  assign when_MmuPlugin_l314 = (MmuPlugin_ports_0_entryToReplace_value == 2'b00);
  assign when_MmuPlugin_l314_1 = (MmuPlugin_ports_0_entryToReplace_value == 2'b01);
  assign when_MmuPlugin_l314_2 = (MmuPlugin_ports_0_entryToReplace_value == 2'b10);
  assign when_MmuPlugin_l314_3 = (MmuPlugin_ports_0_entryToReplace_value == 2'b11);
  assign when_MmuPlugin_l308_1 = MmuPlugin_shared_portSortedOh[1];
  assign when_MmuPlugin_l314_4 = (MmuPlugin_ports_1_entryToReplace_value == 2'b00);
  assign when_MmuPlugin_l314_5 = (MmuPlugin_ports_1_entryToReplace_value == 2'b01);
  assign when_MmuPlugin_l314_6 = (MmuPlugin_ports_1_entryToReplace_value == 2'b10);
  assign when_MmuPlugin_l314_7 = (MmuPlugin_ports_1_entryToReplace_value == 2'b11);
  assign when_MmuPlugin_l338 = ((execute_arbitration_isValid && execute_arbitration_isFiring) && execute_IS_SFENCE_VMA2);
  ...
  always @(*) begin
    ...
    if(execute_CsrPlugin_csr_3073) begin
      _zz_CsrPlugin_csrMapping_readDataInit_24[31 : 0] = csr_utime[31 : 0];
    end
  end
  ...
  always @(*) begin
    ...
    if(execute_CsrPlugin_csr_3201) begin
      _zz_CsrPlugin_csrMapping_readDataInit_25[31 : 0] = csr_utime[63 : 32];
    end
  end
  ...
  assign csr_timerInterrupt = mtip;
  assign csr_softwareInterrupt = msip;
  assign csr_externalInterrupt = meip;
  assign csr_externalInterruptS = seip;
  assign csr_utime = mtime;
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(when_MmuPlugin_l133_1) begin
        MmuPlugin_ports_1_dirty <= 1'b0;
      end
      ...
      if(when_MmuPlugin_l306) begin
        if(when_MmuPlugin_l308) begin
          ...
          if(when_MmuPlugin_l314) begin
            MmuPlugin_ports_0_cache_0_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_1) begin
            MmuPlugin_ports_0_cache_1_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_2) begin
            MmuPlugin_ports_0_cache_2_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_3) begin
            MmuPlugin_ports_0_cache_3_valid <= 1'b1;
          end
        end
        if(when_MmuPlugin_l308_1) begin
          MmuPlugin_ports_1_dirty <= 1'b1;
          if(when_MmuPlugin_l314_4) begin
            MmuPlugin_ports_1_cache_0_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_5) begin
            MmuPlugin_ports_1_cache_1_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_6) begin
            MmuPlugin_ports_1_cache_2_valid <= 1'b1;
          end
          if(when_MmuPlugin_l314_7) begin
            MmuPlugin_ports_1_cache_3_valid <= 1'b1;
          end
        end
      end
      if(when_MmuPlugin_l338) begin
        MmuPlugin_ports_0_cache_0_valid <= 1'b0;
        MmuPlugin_ports_0_cache_1_valid <= 1'b0;
        MmuPlugin_ports_0_cache_2_valid <= 1'b0;
        MmuPlugin_ports_0_cache_3_valid <= 1'b0;
  ...
  always @(posedge clk) begin
    ...
    if(when_MmuPlugin_l140_1) begin
      MmuPlugin_ports_0_cacheHits <= MmuPlugin_ports_0_cacheHitsCalc;
    end
    if(when_MmuPlugin_l140_2) begin
      MmuPlugin_ports_1_requireMmuLockup <= MmuPlugin_ports_1_requireMmuLockupCalc;
    end
    if(when_MmuPlugin_l140_3) begin
      MmuPlugin_ports_1_cacheHits <= MmuPlugin_ports_1_cacheHitsCalc;
    end
    MmuPlugin_shared_dBusRspStaged_payload_data <= MmuPlugin_dBusAccess_rsp_payload_data;
    MmuPlugin_shared_dBusRspStaged_payload_error <= MmuPlugin_dBusAccess_rsp_payload_error;
    MmuPlugin_shared_dBusRspStaged_payload_redo <= MmuPlugin_dBusAccess_rsp_payload_redo;
    if(when_MmuPlugin_l238) begin
    ...
    CsrPlugin_mip_MEIP <= csr_externalInterrupt;
    CsrPlugin_mip_MTIP <= csr_timerInterrupt;
    CsrPlugin_mip_MSIP <= csr_softwareInterrupt;
    CsrPlugin_sip_SEIP_INPUT <= csr_externalInterruptS;
    if(_zz_when) begin
